...
\usepackage{breqn}
\usepackage{amsthm}
\usepackage[style=numeric,minbibnames=3,maxbibnames=3,autopunct=true,babel=hyphen,hyperref=true,abbreviate=false,backend=biber]{biblatex}
\addbibresource{bibliographydiss_n.bib}
\usepackage{tikz}
...
\degreedate{Trinity Term, September 2021}         %the degree date
...
\include{abstract_n}          % include the abstract
